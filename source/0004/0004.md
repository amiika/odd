...
[Last time](../source/0003.html), we implemented a rhythmic engine capable of playing samples and sequences. However, live coding is a performance art. The live coding audience (and the coder) may want to see *what* part of the code is currently generating sound.
