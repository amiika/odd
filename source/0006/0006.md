...
In [Part 5](../source/0005/0005.html), we added a `raw` command to our engine. To understand why that is powerful, we need to step outside our Forth abstraction and look at the raw byte level sound synthesis.
...
This ensures that when you slide the volume, it doesn't "crackle"—the audio engine smooths the transition automatically.
